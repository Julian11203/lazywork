function findById(){
    ...
    $.ajax({
        ...
        success: function(respuesta){
            ...
            '</td><td>' + "<a href='#' class='editar-link' data-bs-toggle='modal' data-bs-target='#actualizarModal' onclick='cargarDatos(\""+respuesta.incidenciaID+"\")'> <i class='material-icons'>edit</i></a>" +
            '</td></tr>'; 
        },
        error: function(xhr) {
            if(xhr.status===404){
    ...
    $.ajax({
        ...
        success: function(respuesta){
            ...
            for(i=0;i<respuesta.length;i++){
                ...
                '</td><td>' + "<a href='#' class='editar-link' data-bs-toggle='modal' data-bs-target='#actualizarModal' onclick='cargarDatos(\""+respuesta[i].incidenciaID+"\")'> <i class='material-icons'>edit</i></a>" +
                '</td></tr>';
            }      
        }
    })
